...
export default function ContactDialog() {
  ...
  useEffect(() => {
    ...
    const onKey = (e: KeyboardEvent) => {
      if (e.key === "Escape") router.replace("/ClientWebsites", { scroll: false });
  ...
  const close = () => router.replace("/ClientWebsites", { scroll: false });
                    ...
                    <Field label="Project type">
                      <div className="relative">
                        <input 
                          ...
                          value="Web & Portals" 
                          readOnly
                          className="input bg-zinc-900/50 text-zinc-300 cursor-not-allowed"
                        />
                        <div className="absolute right-3 top-1/2 -translate-y-1/2">
                          <span className="text-xs text-emerald-400 font-medium">✓ Pre-selected</span>
                        </div>
                      </div>
                    </Field>
                  </div>
