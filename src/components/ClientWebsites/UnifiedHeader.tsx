...
const LINKS = [
  { href: "/ClientWebsites#work", label: "Work", id: "work", icon: Sparkles },
  { href: "/ClientWebsites#process", label: "Process", id: "process", icon: Zap },
];
                ...
                <div className="hidden sm:block">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      >
                        <Link href="/ClientWebsites?contact=open" className="relative z-10 flex items-center gap-2">
                          <motion.span
                            aria-hidden
