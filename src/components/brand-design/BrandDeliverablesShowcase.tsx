...
export function BrandDeliverablesShowcase() {
    ...
    const prevSlide = () => {
        setCurrentIndex(
            (prev) => (prev - 1 + deliverables.length) % deliverables.length,
        );
    };
        ...
        <section>
            <div className="text-center py-12 mb-12 sm:mb-16">
                ...
                <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
                    Everything you need to launch and maintain your brand across
                    all platforms
                </p>
            </div>
                    ...
                    {deliverables.map((_, idx) => (
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: "4px",
                                backgroundColor:
                                    currentIndex === idx ? primary : "#52525b",
                            }}
                        />
                    ))}
                </div>
            ...
            >
                <p className="text-zinc-400 mb-6">
                    All deliverables are provided in multiple formats ready for
                    immediate use across digital and print channels.
                </p>
                <div
