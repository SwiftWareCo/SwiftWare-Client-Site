        ...
        <div className='relative z-10 p-8 sm:p-12 lg:p-16'>
          ...
          <div className='text-center mb-8 sm:mb-12'>
            ...
            <p className='text-lg text-zinc-300 leading-relaxed max-w-3xl mx-auto'>
              A great brand is useless if no one sees it. We don&apos;t just
              design brands—we{' '}
              <span className='font-semibold text-white'>
                integrate them into a complete growth system
              </span>
              .
            </p>
          </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <div className='p-4 rounded-lg bg-zinc-800/20 border border-zinc-700/30'>
                  ...
                  <p className='text-sm text-zinc-400'>
                    Consistent messaging across SEO, content, and ads
                  </p>
                </div>
                <div className='p-4 rounded-lg bg-zinc-800/20 border border-zinc-700/30'>
                  ...
                  <p className='text-sm text-zinc-400'>
                    A conversion-optimized site that embodies your brand
                  </p>
                </div>
                <div className='p-4 rounded-lg bg-zinc-800/20 border border-zinc-700/30'>
                  ...
                  <p className='text-sm text-zinc-400'>
                    Every customer interaction reinforces your promise
                  </p>
                </div>
              </div>
            </div>
          ...
          >
                ...
                <div className='space-y-6'>
                  <div>
                    ...
                    <p className='text-zinc-300 text-sm leading-relaxed'>
                      CJS Golf Academy needed a brand identity that would stand
                      out in a competitive golf instruction market. Their old
                      logo felt generic and failed to convey the premium
                      experience and expertise they offered to aspiring golfers.
                    </p>
                  </div>
                  <div>
                    <h4
                    ...
                    <p className='text-zinc-300 text-sm leading-relaxed'>
                      We created a vibrant, modern brand identity with a
                      cartoon-inspired aesthetic designed to appeal to newer
                      golfers while maintaining credibility. The playful yet
                      professional logo gives CJS a youthful, approachable feel,
                      making golf instruction feel accessible and fun—exactly
                      what the academy needed to attract the next generation of
                      golfers.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className='text-zinc-300 text-sm leading-relaxed'>
                      The rebrand positioned CJS Golf Academy as a premium
                      instruction provider, resulting in a 45% increase in
                      membership inquiries and stronger brand recognition within
                      the local golf community.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <p className='text-zinc-400 mb-4'>
                Let&apos;s discuss how we can build your complete brand
                ecosystem:
              </p>
