...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'Yes. The mobile app caches jobs and syncs when online. Field technicians can create work orders, capture photos, and log time even without internet connectivity.',
    icon: Smartphone,
  },
  {
    ...
    answer:
      'Yes. We can add Stripe or your preferred provider. Accept payments on-site via the mobile app, automatically reconcile invoices, and track payment status in real-time.',
    icon: CreditCard,
  },
  {
    id: 'customization',
    ...
    answer:
      'Highly customizable. We build on your specific workflows, not the other way around. Custom fields, business logic, integrations, and reporting are all standard.',
    icon: Shield,
  },
  {
    id: 'support',
    ...
    answer:
      'Ongoing support included. We provide training, documentation, bug fixes, feature requests, and performance optimization as part of our service.',
    icon: Smartphone,
  },
  {
    id: 'timeline',
    ...
    answer:
      "Most projects are completed within 4-8 weeks. This includes discovery, design, development, testing, and deployment. We work in weekly sprints with regular check-ins to ensure we're meeting your needs.",
    icon: Shield,
  },
];
      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6'>
        ...
        >
          ...
          <p className='text-xl text-zinc-300 max-w-2xl mx-auto'>
            Everything you need to know about our CRM solution for field service
            businesses.
          </p>
        </motion.div>
