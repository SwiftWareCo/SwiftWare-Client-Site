...
const WORKFLOW_STEPS = [
  {
    ...
    description: "We dive deep into your operations, workflows, and pain points. No assumptions, just thorough analysis.",
    activities: [
  ...
  },
  {
    ...
    description: "We design a system that fits your business like a glove, not the other way around.",
    activities: [
  ...
  },
  {
    ...
    description: "We build in sprints, showing progress weekly and adapting based on your feedback.",
    activities: [
  ...
  },
  {
    ...
    description: "Every feature is tested thoroughly to ensure reliability and performance.",
    activities: [
  ...
  },
  {
    ...
    icon: Rocket,
    title: "Launch & Train",
    description: "We handle the deployment and ensure your team is fully trained and confident.",
    activities: [
  ...
  },
  {
    ...
    description: "We're here for the long haul, providing support, enhancements, and optimization.",
    activities: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-xl text-zinc-300 max-w-3xl mx-auto">
            Our proven process ensures we deliver exactly what your business needs, built to fit perfectly.
          </p>
        </motion.div>
                      ...
                      <div className="grid sm:grid-cols-2 gap-3">
                        {step.activities.map((activity, activityIndex) => (
                          <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.4, delay: index * 0.1 + activityIndex * 0.05 }}
