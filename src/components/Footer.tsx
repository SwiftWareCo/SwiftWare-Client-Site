                    ...
                    <div className="grid gap-8 md:gap-12 md:grid-cols-1 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p className="max-w-md leading-relaxed text-gray-700 dark:text-zinc-400">
                                Building tomorrow&apos;s software today. We
                                craft bespoke solutions that scale with your
                            ...
                            <div className="space-y-3 text-gray-600 dark:text-zinc-400">
                                ...
                                <div className="flex flex-wrap items-center gap-4 text-sm">
                                    <Link
                                        ...
                                        className="group inline-flex items-center gap-2 transition-colors hover:text-gray-900 dark:hover:text-white"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        <span
                                            className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gray-900/5 text-gray-700 transition-colors group-hover:bg-gray-900/10 group-hover:text-gray-900 dark:bg-white/10 dark:text-zinc-200 dark:group-hover:bg-white/20 dark:group-hover:text-white"
                                            aria-hidden="true"
                                        >
