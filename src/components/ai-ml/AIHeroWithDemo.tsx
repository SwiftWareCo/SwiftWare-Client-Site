    ...
    >
      ...
      >
        ...
        >
              ...
              <div className='relative inline-flex flex-col items-center'>
                <div className='h-[1.3em] overflow-hidden'>
                  <AnimatePresence mode='wait'>
                    <motion.span
                      key={['Works', 'Evolves', 'Improves'][textIndex]}
                    ...
                    >
                      {['Works', 'Evolves', 'Improves'][textIndex]}
                    </motion.span>
                  </AnimatePresence>
                </div>
          ...
          >
            Deploy AI agents that handle calls, answer questions from your
            documents, and automate repetitive workflows—24/7.
          </motion.p>
