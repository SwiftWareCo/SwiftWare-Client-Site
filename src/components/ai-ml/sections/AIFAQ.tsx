...
const FAQ_ITEMS: FAQItem[] = [
    {
        ...
        answer: "Most businesses have valuable insights trapped in documents, emails, and databases that are impossible to access quickly. SwiftMind transforms this scattered information into an intelligent, searchable knowledge base that provides instant answers, accelerates decision-making, and eliminates time wasted searching for information.",
        icon: Brain,
    },
    {
        id: "data-security",
        question: "How secure is our data?",
        answer: "Enterprise-grade encryption with multi-tenant isolation, role-based access control, and comprehensive audit logging. Your data never leaves your secure environment.",
        icon: Shield,
    },
    {
        id: "file-formats",
        question: "What file formats are supported?",
        answer: "We support PDFs, Word docs, Excel files, CSVs, plain text, and can integrate with your existing document management systems.",
        icon: Database,
    },
    {
        id: "hybrid-search",
        question: "How does the hybrid search work?",
        answer: "Our system combines semantic vector search for contextual understanding with traditional keyword matching for precision, giving you the best of both approaches.",
        icon: Zap,
    },
];
        ...
        <section className="relative overflow-hidden py-20">
            ...
            <div className="absolute inset-0 -z-10">
                ...
                <div
                    ...
                    style={{
                        backgroundColor: withAlpha(colorsRGB.secondaryRGB, 0.1),
                    }}
                />
            </div>
            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6">
                ...
                >
                    ...
                    <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
                        Everything you need to know about our AI-powered
