    ...
    const animate = () => {
      ...
      nodePositions.forEach((node, i) => {
        nodePositions.forEach((otherNode, j) => {
          ...
          const shouldConnect =
            (nodeStation === 'Pro Shop' && otherStation === 'Tee Box') ||
            (nodeStation === 'Tee Box' && otherStation === 'Fairway') ||
            (nodeStation === 'Fairway' && otherStation === 'Green') ||
            (nodeStation === 'Green' && otherStation === 'Clubhouse') ||
      ...
      <div className='max-w-7xl mx-auto px-0 md:px-4 lg:px-6 relative w-full'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl p-2 text-zinc-300 max-w-3xl mx-auto leading-relaxed'>
            From tee to green, every aspect of your golf course operations
      ...
      >
          ...
          animate={
            !reduce
              ? {
                  ...
                  scale: isHoveredInternal ? [1, 1.01, 1] : [1, 0.99, 1],
                }
              : {}
          }
          transition={{
        ...
        >
          ...
          <motion.div
            ...
            animate={
              isHoveredInternal && !reduce ? { rotate: [0, 3, -3, 0] } : {}
            }
                ...
                {tooltipPosition.tooltipBelow ? (
                  <div
                    ...
                    style={{
                      ...
                      borderBottom: '8px solid rgb(63, 63, 70)',
                    }}
                  >
                    <div
                      ...
                      style={{
                        ...
                        borderBottom: '7px solid rgb(24, 24, 27)',
                      }}
                    />
                  </div>
                ) : (
